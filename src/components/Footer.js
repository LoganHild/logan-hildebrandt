...
export default function Footer() {
    return (
        <div className="footer">
            ...
            <p className="copyright">Copyright <i class="far fa-copyright"></i> 2021</p>
            <div>
                ...
                <a href="https://github.com/LoganHild" rel="noreferrer" target="_blank"><i class="fab fa-github fa-2x social"></i></a>
            </div>
        </div>
    )
}