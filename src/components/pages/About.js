  ...
  return (
    <div className='aboutContainer'>
      ...
      <article className="aboutMe col-lg-4 col-md-6">      
        ...
        <p className="about">
           I recently took on the commitment of completing the Full-Stack Web Development Boot-Camp course offered by the University of Minnesota.
        ...
        <p className="about">
           Nothing can really compare to the ability to create something from nothing, and when it comes to web development, the only limit is a person's imagination. 
        </p>
